...
export function ModelLibraryPage() {
  ...
  return <>
    ...
    <PageActions><button className={controls.iconButton} aria-label={t("添加模型")} disabled={cursorBusy} onClick={openNew}><Icon icon={addIcon} size="1.1em" /></button></PageActions>
    <PageContent title={t("模型库")} sections={[{ key: "model-library", estimatedHeight: estimatedModelHeight, content }]} />
